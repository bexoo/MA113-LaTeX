...
We have a function $f(x(t),y(t)) = z.$ Note that $f$ can be written as either a function of just $t$ or also a function of $x(t)$ and $y(t)$.
...
\end{align*}
$\angled{\frac{\partial f}{\partial x}} = \nabla f(x,y)$, or the gradient.
