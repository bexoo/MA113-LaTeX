...
\newcommand{\vecw}{\overrightarrow{w}}
\newcommand{\la}{\langle}
\newcommand{\ra}{\rangle}
...
\subsection{Some notation things}
...
We take the cross product of sets like this.
...
\[ \vv{r}(t) = \vv{A} + t\vecv \]
where $\vv{A}$ is the origin point of the line and $\vecv$ is the direction of the line, which we can think of as taking the place of the slope. Usually we combine these two terms into a single vector. 
